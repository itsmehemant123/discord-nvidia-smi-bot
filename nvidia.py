...
class NvidiaGPUInfoBot:
    ...
    async def info(self, ctx):
        ...
        for i in range(deviceCount):
            ...
            gpuInfo += "*Wattage*: " + (dCurrentWattage/1000) + "W / " + (dMaxWattage/1000) + "W\n"
